document.getElementById('connectWallet').addEventListener('click', async () => {
    ...
    document.getElementById('title').textContent = customStrings.title.replace('{name}', collectionInfo.name);
    document.getElementById('underTitle').textContent = indexPageInfo.underTitle;

    document.addEventListener('DOMContentLoaded', (event) => {
        document.getElementById('connectWallet').addEventListener('click', connectWalletFunction);
    });
